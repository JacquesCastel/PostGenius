...
export const LANDING_DEFAULTS = {
  hero: {
    ...
    subtitle:
      "LinkeePost transforme votre expertise en posts qui vous ressemblent : campagnes guidées par l'IA, veille de votre secteur, publication programmée à votre rythme — vous ne faites plus que valider.",
  },
  plans: [
    {
      name: "Essentiel",
    ...
    },
    {
      ...
      features: [
        ...
        "Score d'engagement et optimisation des posts",
    ...
    },
    {
      ...
      features: [
        ...
        "Module Événements (salons, forums) + notifications jour-J",
  ...
  faq: [
    {
      q: "Comment LinkeePost se connecte-t-il à LinkedIn ?",
